...
void Sig_Xsec_wt(TString & sig_samp, double& sig_xsec_wt){
    ...
    ///////////////////////// ggF Graviton Sample ///////////////////
    //2016: ggFG //Samples not available // Currently using samples from 2017
    if (sig_samp == "ggFG_1000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_1200_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_1400_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_1600_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_1800_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_2000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_2500_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_3000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_3500_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_4000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFG_4500_MC2016")   sig_xsec_wt = 1/50000.0;
    ...
    //2016: ggFRad //Samples not available; using 2017 samples
    if (sig_samp == "ggFRad_800_MC2016")    sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_1000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_1200_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_1400_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_1600_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_1800_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_2000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_2500_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_3000_MC2016")   sig_xsec_wt = 1/43000.0;
    if (sig_samp == "ggFRad_3500_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_4000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_4500_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_5000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_5500_MC2016")   sig_xsec_wt = 1/48000.0;
    if (sig_samp == "ggFRad_6000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_6500_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_7000_MC2016")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_7500_MC2016")   sig_xsec_wt = 1/49000.0;
    if (sig_samp == "ggFRad_8000_MC2016")   sig_xsec_wt = 1/50000.0;
    ...
    //2018: ggFRad; Not all samples are available so using 2017 samples
    ...
    if (sig_samp == "ggFRad_1600_MC2018")   sig_xsec_wt = 1/50000.0;
    ...
    if (sig_samp == "ggFRad_3000_MC2018")   sig_xsec_wt = 1/43000.0;
    if (sig_samp == "ggFRad_3500_MC2018")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_4000_MC2018")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_4500_MC2018")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_5000_MC2018")   sig_xsec_wt = 1/50000.0;
    if (sig_samp == "ggFRad_5500_MC2018")   sig_xsec_wt = 1/48000.0;
    ...
    if (sig_samp == "ggFRad_7500_MC2018")   sig_xsec_wt = 1/49000.0;
    if (sig_samp == "ggFRad_8000_MC2018")   sig_xsec_wt = 1/50000.0;
