...
#que = ["Baseline","ZSB","ZSBHP","ZSBHPVBF","ZSBHPVBFfail","ZSR","ZSRHP","ZSRHPVBF","ZSRHPVBFfail"]
#que = ["ZSBHPVBF","ZSRHPVBF","ZSBHPVBFfail","ZSRHPVBFfail"]
#que = ["ZSBLP","ZSRLP","ZSBLPVBF","ZSRLPVBF","ZSBLPVBFfail","ZSRLPVBFfail"]
#que = ["ZSBLP","ZSBLPVBF","ZSBLPVBFfail"]
que = ["ZSRLPVBF","ZSRLPVBFfail"]
