...
dataSamples=["MET_2017B","MET_2017C","MET_2017D","MET_2017E","MET_2017F"]
...
##os.system("hadd -f AN_ORv1_files/{1}_ORv1/Sig_{0}_{1}_Accept_LowPurity.root AN_ORv1_files/{1}_ORv1/plotObs_{0}_*.root".format(cat,year))
