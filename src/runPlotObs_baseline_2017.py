...
start = datetime.now()
print "started 2017 at: {}".format(start)
...
time.sleep(20)
print "hadding "+cat
os.system("hadd AN_v0_Closure_VBF_trigwt/{0}_AN_v0_2017_v1.root AN_v0_Closure_VBF_trigwt/plotObs_{0}_baseline_*.root".format(cat))
time.sleep(20)
