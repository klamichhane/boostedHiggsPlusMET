...
year = sys.argv[2]      #"137fb" "2016" "2017" "2018"
...
if sample=="VBFG" or sample=="ggFG": ytitle = "#sigma(G{}) #times BR(G #rightarrow ZZ) (fb)".format(fwd); xtitle = "M_{Graviton} (GeV)"
elif sample=="VBFWp" or sample=="ggFWp": ytitle = "#sigma(W'{}) #times BR(W' #rightarrow WZ) (fb)".format(fwd); xtitle = "M_{Wprime} (GeV)"
elif sample=="VBFRad" or sample=="ggFRad": ytitle = "#sigma(Rad{}) #times BR(Rad #rightarrow ZZ) (fb)".format(fwd); xtitle = "M_{Radion} (GeV)"
...
can.SaveAs(year+"/"+sample+"_Limit_HP_"+year+".pdf")
