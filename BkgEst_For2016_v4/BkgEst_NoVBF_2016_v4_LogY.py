...
l1.AddEntry(hE,"N_{SR}^{predicted}: HP No VBF","p")
l1.AddEntry(hT,"N_{SR}^{MC bkg}: HP No VBF","p")
l1.Draw()

#txt1 = r.TText(.55,.65,"Ratio = 1.01")
#txt1.SetNDC()
##txt1.SetTextFont(51)
...
c.SaveAs("BkgEst_NoVBF_2016_v4_LogY.png")
